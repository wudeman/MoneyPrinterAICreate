...
from app.controllers.v1 import video, llm_model_controller, llm, template_controller, dict_controller, media, task
...
api_v1_router.include_router(media.router, tags=["媒体生成"])
